...
public class SymptomsProcess {
    ...
    /**
     * Counts occurrences of symptoms and writes the result in the file "result.out"
     */

    public TreeMap<String, Integer> count(List<String> symptoms) {

        /**
         * Create a Treemap that will count occurrences of each symptom read in the List returned by the ReadSymptomDataFromFile class
         * @param symptoms listing of all symptoms obtained from a data source generated by the ReadSymptomDataFromFile class
         ...
         * @return the symptomsCountMap TreeMap with symptom for keys and nb of occurrence for value
         */
    ...
    public void writeResult(TreeMap<String, Integer> symptomsCountAndSorted) {
        ...
        /**
         * Writes the symptomsCountMap into the "result.out" file
         */
